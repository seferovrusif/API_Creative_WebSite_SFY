...
{
    public partial class size_create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HexCode = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Handle_SizeId = table.Column<int>(type: "int", nullable: false),
                    Handle_ColorId = table.Column<int>(type: "int", nullable: false),
                    Handle_MaterialId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Handle_ColorId,
                        principalTable: "Color",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_Bag_Material_Handle_MaterialId",
                        column: x => x.Handle_MaterialId,
